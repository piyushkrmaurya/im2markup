...
def process_one_shard(corpus_params, params):
    ...
    dataset = Dataset(
        ...
        data=_data,
        dirs=_dir,
        sort_key=img_sort_key if opt.data_type == "img" else text_sort_key,
...
def preprocess(opt):
    ...
    src_reader = ImageDataReader.from_opt(opt)
    tgt_reader = TextDataReader.from_opt(opt)
    align_reader = TextDataReader.from_opt(opt)
...
if __name__ == "__main__":
    ...
    with open("opts_preprocessing.json", "r") as f:
